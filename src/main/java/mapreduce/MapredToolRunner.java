...
public class MapredToolRunner extends Configured implements Tool  {
        ...
        public int run(String[] args) throws  IOException, InterruptedException,ClassNotFoundException{
           if(args.length != 2){
            ...
            job.setJarByClass(MapredToolRunner.class);
        ...
        public static void main(String[] args) throws Exception{
            int exitcode = ToolRunner.run(new MapredToolRunner(), args);
